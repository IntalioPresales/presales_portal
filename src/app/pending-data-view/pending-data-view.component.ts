...
export class PendingDataViewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.globals.currentuser.firstname == 'Mazen' && this.globals.currentuser.lastname == 'FARAH' || this.globals.currentuser.firstname == 'Stephanie' && this.globals.currentuser.lastname == 'AZARIAN' || this.globals.currentuser.firstname == 'Antoine' && this.globals.currentuser.lastname == 'HRAOUI' || this.globals.currentuser.firstname == 'MarieTherese' && this.globals.currentuser.lastname == 'AMMOUN') {
      ...
      this.member = true;
      this.displayedColumns = ['firstname', 'lastname', 'country', 'fullname', 'appreviation', 'contactname', 'contacttitle', 'contactemail', 'contactnumber', 'ppi', 'clienttype', 'numberofemployees', 'clientindustry', 'url', 'learn', 'recieveddate', 'clientsubmissiondate', 'projectdesc', 'otherobservation', 'deliverytimeline', 'requiredtechnology', 'chanceofWinning', 'competitors', 'budgetrange', 'proposaltype', 'dueDate', 'uploads'];
  ...
  //   if(id.includes(str)){
  //     this.router.navigate(['/viewopportunity',firstname,lastname,str]);
  //     return
  //   }
  //   else{
  //     var number=this.getNumber(id);
  //     this.router.navigate(['/viewopportunity',firstname,lastname,number]);
  //   }
  // }
